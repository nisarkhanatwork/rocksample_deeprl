...
One of the models performed like this after 3 hours(intel Core i7 vPro 7th  Gen)of training with the settings in the code(you can see it picks up 0s and also avoids 1s):
